"""
Django settings for social_auth_example_django project.
...
ROOT_URLCONF = 'social_auth_example_django.urls'
...
WSGI_APPLICATION = 'social_auth_example_django.wsgi.application'
